...
import { resolveAssetPath } from "@/utils/base-path";
      ...
      <div className="page" ref={container}>
        <section className="about-hero">
          <div className="about-hero-bg">
            <img
              src={resolveAssetPath("about/hero.jpg")}
              alt="ISOChrome About Hero Image"
            />
          </div>
            ...
            <div className="about-copy-wrapper">
              ...
              <div className="about-copy-img">
                <div className="about-copy-img-wrapper">
                  <ParallaxImage
                    src={resolveAssetPath("about/about-copy.jpg")}
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="expertise-img-1">
                  <img
                    src={resolveAssetPath("about/expertise-img-1.jpg")}
                    alt=""
                  />
                </div>
              </div>
              <div className="row">
                <div className="expertise-img-2">
                  <img
                    src={resolveAssetPath("about/expertise-img-2.jpg")}
                    alt=""
                  />
                </div>
              </div>
        ...
        <section className="about-outro-banner">
          <div className="about-outro-img">
            <ParallaxImage
              src={resolveAssetPath("about/about-outro.jpg")}
              alt=""
              speed={0.2}
            />
          </div>
        ...
        <section className="founder-voice">
          <div className="container">
            ...
            <div className="founder-image">
              <img src={resolveAssetPath("about/founder.jpg")} alt="" />
            </div>
                ...
                <div className="logo-item" key={index}>
                  ...
                  <img
                    src={resolveAssetPath(
                      `client-logos/${String.fromCharCode(

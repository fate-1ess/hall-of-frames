...
import BasePathImage from "@/components/BasePathImage/BasePathImage";
  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <BasePathImage src="/images/work/work_006.jpeg" alt="" />
      </section>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <BasePathImage src="/images/work/work_001.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_021.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_003.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_009.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_015.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_023.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_024.jpeg" alt="" />
          </div>
          <div className="sp-img">
            <BasePathImage src="/images/work/work_001.jpeg" alt="" />
          </div>

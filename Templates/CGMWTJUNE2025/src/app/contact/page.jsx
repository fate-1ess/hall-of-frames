...
import { createNavigationTargets } from "@/utils/basePath";
...
const page = () => {
  ...
  const handleNavigation = (e, route) => {
    e.preventDefault();
    const target = createNavigationTargets(route);
    ...
    <div className="contact" ref={contactRef}>
      <div className="contact-img-wrapper">
        <div className="contact-img">
          <BasePathImage src="/images/contact/contact.jpeg" alt="" />
        </div>
      </div>

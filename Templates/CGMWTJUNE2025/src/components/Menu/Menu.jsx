...
const Menu = ({ onMenuStateChange }) => {
  ...
  useEffect(() => {
    setCurrentPath(getCurrentRelativePath());
  }, []);
  ...
  const getRelativeTarget = (path) => toRelativePath(path);

  const isExactPath = (path) => currentPath === getRelativeTarget(path);
  ...
  const navigateTo = (path) => {
    ...
    setTimeout(() => {
      const target = createNavigationTargets(path);
            ...
            <div className="revealer">
              <a
                ...
                onClick={(e) => {
                  ...
                  const target = createNavigationTargets("/");
                  router.push(target.route, {
                    onTransitionReady: slideInOut,
                  });
                }}

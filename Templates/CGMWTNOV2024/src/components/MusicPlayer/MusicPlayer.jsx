  ...
  const songs = [
    {
      ...
      diskArt: resolveAssetPath("/songs/dreamland.png"),
      mp3: resolveAssetPath("/songs/dreamland.mp3"),
    },
    {
      id: 2,
      title: "Gameplay",
      artist: "By Balanced Pitch",
      diskArt: resolveAssetPath("/songs/gameplay.png"),
      mp3: resolveAssetPath("/songs/gameplay.mp3"),
    },
  ];

        ...
        <section className="articles">
          <div className="articles-row">
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article1.jpg")}
                  alt="AI Voices Battle"
                />
            ...
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article2.jpg")}
          ...
          <div className="articles-row">
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article3.jpg")}
                  alt="Artists' Rights"
                />
                <div className="article-date">
                  <p>6.19.2024 &nbsp; News</p>
            ...
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article4.jpg")}
                  alt="AI and Music"
                />
                <div className="article-date">
                  <p>6.19.2024 &nbsp; News</p>
          ...
          <div className="articles-row">
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article5.jpg")}
                  alt="Policy Reforms"
                />
                <div className="article-date">
                  <p>6.19.2024 &nbsp; News</p>
            ...
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article6.jpg")}
          ...
          <div className="articles-row">
            <div className="article">
              <div className="article-img">
                <img
                  src={resolveAssetPath("/updates/article7.jpg")}
                  alt="Future of AI"
                />
                <div className="article-date">
                  <p>6.19.2024 &nbsp; News</p>

      ...
      <div className="page about">
        ...
        <section className="about-hero">
          <div className="about-hero-img">
            <img src={assetPath("about/about-hero.jpg")} alt="" />
          </div>
        </section>
        ...
        <section className="services">
          <div className="services-col">
            <div className="services-banner">
              <img src={assetPath("about/services-banner.jpg")} alt="" />
            </div>
        ...
        <section className="about-banner-img">
          <div className="about-banner-img-wrapper">
            <img src={assetPath("about/about-banner.jpg")} alt="" />
          </div>
        </section>
        ...
        <section className="fav-tools">
          ...
          <div className="fav-tools-list">
            <div className="fav-tools-list-row">
              <div className="fav-tool">
                <div className="fav-tool-img">
                  <img src={assetPath("about/tool-1.jpg")} alt="" />
                </div>
              ...
              <div className="fav-tool">
                <div className="fav-tool-img">
                  <img src={assetPath("about/tool-2.jpg")} alt="" />
                </div>
              ...
              <div className="fav-tool">
                <div className="fav-tool-img">
                  <img src={assetPath("about/tool-3.jpg")} alt="" />
                </div>
            ...
            <div className="fav-tools-list-row">
              <div className="fav-tool">
                <div className="fav-tool-img">
                  <img src={assetPath("about/tool-4.jpg")} alt="" />
                </div>
                <h4>ShotDeck</h4>
              ...
              <div className="fav-tool">
                <div className="fav-tool-img">
                  <img src={assetPath("about/tool-5.jpg")} alt="" />
                </div>
                <h4>Frame.io</h4>
              ...
              <div className="fav-tool">
                <div className="fav-tool-img">
                  <img src={assetPath("about/tool-6.jpg")} alt="" />
                </div>
                <h4>Celtx</h4>

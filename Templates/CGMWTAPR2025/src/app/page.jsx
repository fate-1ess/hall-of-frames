...
import { getHeroImage, getProductImage } from "@/utils/assetPaths";
      ...
      {showPreloader && (
        <>
          <div className="preloader-overlay">
            ...
            <div
              className="loader-2"
              style={{ backgroundImage: `url(${getProductImage("product_001.jpeg")})` }}
            ></div>
          </div>
      ...
      <div className="home-page-content">
        ...
        <div className="home-page-footer">
          ...
          <div className="hp-footer-col">
            ...
            >
              <img src={getProductImage("product_001.jpeg")} alt="" />
            </div>
            <div
              className="product-preview-hero"
              onClick={() => navigateTo(`/catalogue/earbud-ad-mockup`)}
            >
              <img src={getProductImage("product_002.jpeg")} alt="" />
            </div>
            <div
              className="product-preview-hero"
              onClick={() => navigateTo(`/catalogue/minimal-phone-mockup`)}
            >
              <img src={getProductImage("product_003.jpeg")} alt="" />
            </div>
          </div>
        </div>
      </div>

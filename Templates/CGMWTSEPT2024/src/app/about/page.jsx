    ...
    <ReactLenis root>
      <div className="about-page" ref={container}>
          ...
          <div className="about-intro">
            <div className="col about-portrait-img">
              <div className="about-portrait">
                <Image
                  src={withBasePath("/about/portrait-min.jpg")}
                  alt="Portrait of Stefan Markovic"
                  fill
            ...
            <div className="col about-copy-wrapper">
              ...
              <div className="about-copy" ref={aboutCopyRef}>
                <h3>
                  ...
                  of what&rsquo;s possible on the web. His approach focuses on
                ...
                <h3>
                  ...
                  interactive realities. Whether it&rsquo;s a sleek portfolio site, a
                ...
                <h3>
                  ...
                  new tools, techniques, and frameworks. He&rsquo;s not just a
        ...
        <div className="about-hero-img" ref={heroImgRef}>
          <Image
            src={withBasePath("/about/portrait-2-min.jpg")}
            alt="Portrait of Stefan Markovic outdoors"
            fill
            sizes="100vw"
            style={{ objectFit: "cover" }}
            priority

...
const Photos = () => {
  ...
  slideImgElem.src = withBasePath(`/assets/img${currentImg}.jpg`);
    ...
    { scope: sliderRef, dependencies: [withBasePath] }
  );
    ...
    <>
      <div className="slider" ref={sliderRef}>
        <div className="slider-images" ref={sliderImagesRef}>
          <div className="img">
            <NextImage
              src={withBasePath("/assets/img1.jpg")}
              alt="Portrait of a saxophonist in warm lighting"
              fill
              sizes="100vw"
        ...
        <div className="slider-preview">
          {[1, 2, 3, 4].map((num) => (
            <div
              ...
              ref={(el) => {
                previewsRef.current[num - 1] = el;
              }}
            >
              <NextImage
                src={withBasePath(`/assets/img${num}.jpg`)}
                alt={`Preview ${num} from concert photography series`}
                fill
